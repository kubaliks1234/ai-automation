                ...
                >
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-400 mt-3">
                            Zur Ausübung Ihrer Rechte wenden Sie sich bitte an: <a href="mailto:jakub@jakubkaczmarek.de" className="text-cyan-400 hover:underline">jakub@jakubkaczmarek.de</a>
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-400">
                            ...
                            Sebastian-Frank-Str. 11<br />
                            86609 Donauwörth<br />
                            E-Mail: <a href="mailto:jakub@jakubkaczmarek.de" className="text-cyan-400 hover:underline">jakub@jakubkaczmarek.de</a>
                        </p>
                    </section>
                </motion.div>
            </div>
