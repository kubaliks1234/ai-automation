...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      <SEOMeta
        title="Handwerker Marketing Blog | Mehr Anfragen & Kundengewinnung für Handwerk | Jakub Kaczmarek"
        ...
        keywords="Handwerker Marketing, Kundengewinnung Handwerk, Google Ads Handwerker, Meta Ads Handwerk, Anfragen Handwerk, Marketing Handwerksbetrieb, Donau-Ries, Donauwörth"
